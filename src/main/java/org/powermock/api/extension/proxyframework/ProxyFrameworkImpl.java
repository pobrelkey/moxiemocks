...
public class ProxyFrameworkImpl implements ProxyFramework {
    ...
    /**
     *  If the given type is a proxy class generated by <a href="http://cglib.sourceforge.net/">CGLIB</a>,
     *  return the unproxied type; else just return the given type.
     */
    ...
    /**
     *  Returns <code>true</code> if and only if the given type is a proxy class generated by <a href="http://cglib.sourceforge.net/">CGLIB</a>.
     */
